        ...
        <View style={{ flex: 1, flexDirection: "row" }}>
          <View style={Substyle.counter}>
            ...
            <View style={Substyle.numberCounter}>
              <Text style={{ fontSize: 20 }}>{props.item.Total}</Text>
            </View>
          </View>
          <View style={Substyle.counter}>
            <Text style={Substyle.text2}>Attended</Text>
            <View style={Substyle.numberCounter}>
              <Text style={{ fontSize: 20 }}>{props.item.Attended}</Text>
            </View>
          </View>
          <View style={Substyle.counter}>
            ...
            >
              {(fill) => (
                <Text style={{ fontSize: 10 }}>{Math.floor(fill)}%</Text>
              )}
            </AnimatedCircularProgress>
          </View>
        </View>
